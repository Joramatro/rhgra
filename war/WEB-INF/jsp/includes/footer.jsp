	...
	<div id="copyright">
		...
		<div class="container">
			...
			<jsp:useBean id="date" class="java.util.Date" />
				<p>
				&copy; <fmt:formatDate value="${date}" pattern="yyyy" />,&nbsp;<a target="_blank" href="https://plus.google.com/+Reservarhotelgranada1" rel="publisher"><span id="_publisher8" itemscope itemtype="http://schema.org/Organization">
<span itemprop="name">Reservar Hotel Granada</span></span></a><i style="margin-top: -18px;" class="ico-color ico-brightness-increase"></i>
