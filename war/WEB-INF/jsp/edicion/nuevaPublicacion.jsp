...
Autor: <input type="text" id="autor" name="autor" size="25" maxlength="50" value="Raúl"/><br><br>	
Google+: <input type="text" style="width: 433px;" id="googleAutor" name="googleAutor" value="https://plus.google.com/108779349004721373159?rel=author" size="250" maxlength="570"/><br><br>	
